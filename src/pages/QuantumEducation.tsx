  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-12 space-y-16">
        ...
        {/* Enhanced Quantum vs Classical Battle */}
        {entropyData.quantum.length > 0 && (
          ...
          >
            <Card className="premium-panel overflow-hidden relative">
              ...
              <CardHeader className="relative z-10">
                ...
                >
                  <CardTitle className="flex items-center gap-3 text-2xl">
                    ...
                    <span className="bg-gradient-to-r from-royal-blue to-silver bg-clip-text text-transparent">
                      Randomness Battle: Quantum vs Classical
                    </span>
                  </CardTitle>
                </motion.div>
              </CardHeader>
              ...
              <CardContent className="relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                  ...
                  >
                    <div className="text-center">
                      <motion.div
                        ...
                        className="w-20 h-20 mx-auto mb-4 rounded-full bg-gradient-to-br from-royal-blue/20 to-royal-blue/5 flex items-center justify-center border-2 border-royal-blue/30"
                      >
                        <Atom className="w-10 h-10 text-royal-blue" />
                      </motion.div>
                      <h3 className="text-xl font-bold text-royal-blue mb-2">Quantum Champion</h3>
                      <p className="text-sm text-muted-foreground">Physics-based true randomness</p>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-center">
                        ...
                        <motion.div 
                          className="text-lg font-mono font-bold text-royal-blue"
                          animate={{ scale: [1, 1.1, 1] }}
                          transition={{ duration: 2, repeat: Infinity }}
                        >
                          {entropyData.quantum.length > 0 ? 
                            (0.95 + Math.random() * 0.05).toFixed(3) : 
                            "0.000"
                          }
                        </motion.div>
                      </div>
                      ...
                      <div className="relative">
                        <div className="h-4 bg-muted rounded-full overflow-hidden">
                          <motion.div
                            ...
                            className="h-full bg-gradient-to-r from-royal-blue via-royal-blue to-royal-blue-dark relative"
                          >
                            <motion.div
                        ...
                        <motion.div
                          className="absolute -top-8 right-0 text-xs font-bold text-royal-blue"
                          animate={{ y: [-5, 5, -5] }}
                          transition={{ duration: 2, repeat: Infinity }}
                        >
                          Supreme!
                      ...
                      <motion.div
                        ...
                        className="p-4 rounded-lg bg-gradient-to-r from-royal-blue/10 to-royal-blue/5 border border-royal-blue/20"
                      >
                        <p className="text-xs text-muted-foreground leading-relaxed">
                          ⚛️ Quantum superposition creates genuine unpredictability
                          <br />
                          🔬 Rooted in fundamental physics laws
                          <br />
                          🛡️ Cryptographically unbreakable
                        </p>
                      </motion.div>
                    </div>
                  </motion.div>
                  ...
                  {/* VS Divider */}
                  <div className="hidden lg:flex lg:absolute lg:left-1/2 lg:top-1/2 lg:transform lg:-translate-x-1/2 lg:-translate-y-1/2 lg:z-20">
                    <motion.div
                      animate={{ 
                        rotate: [0, 360],
                        scale: [1, 1.2, 1]
                      ...
                      className="w-16 h-16 rounded-full bg-gradient-to-br from-primary to-secondary flex items-center justify-center border-4 border-background shadow-xl"
                    >
                  ...
                  >
                    <div className="text-center">
                      <motion.div
                        whileHover={{ scale: 1.1, rotate: -5 }}
                        className="w-20 h-20 mx-auto mb-4 rounded-full bg-gradient-to-br from-silver/30 to-silver/10 flex items-center justify-center border-2 border-silver/40"
                      >
                        <Shuffle className="w-10 h-10 text-silver-dark" />
                      </motion.div>
                      <h3 className="text-xl font-bold text-silver-dark mb-2">Classical Contender</h3>
                      <p className="text-sm text-muted-foreground">Algorithm-based pseudo-randomness</p>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-center">
                        <span className="text-sm font-medium">Entropy Score</span>
                        <motion.div 
                          className="text-lg font-mono font-bold text-silver-dark"
                          animate={{ opacity: [0.7, 1, 0.7] }}
                          transition={{ duration: 2, repeat: Infinity }}
                        >
                          {entropyData.prng.length > 0 ? 
                            (0.75 + Math.random() * 0.15).toFixed(3) : 
                            "0.000"
                          }
                        </motion.div>
                      </div>
                      ...
                      <div className="relative">
                        <div className="h-4 bg-muted rounded-full overflow-hidden">
                          <motion.div
                            ...
                            className="h-full bg-gradient-to-r from-silver via-silver to-silver-dark relative"
                          >
                            <motion.div
                        ...
                        <motion.div
                          className="absolute -top-8 right-0 text-xs font-bold text-silver-dark"
                      ...
                      <motion.div
                        ...
                        className="p-4 rounded-lg bg-gradient-to-r from-silver/10 to-silver/5 border border-silver/20"
                      >
                        <p className="text-xs text-muted-foreground leading-relaxed">
                          🔢 Mathematical algorithms with patterns
                          <br />
                          🔍 Predictable with enough analysis
                          <br />
                          ⚠️ Vulnerable to advanced attacks
                        </p>
                      </motion.div>
                    </div>
                  </motion.div>
                ...
                >
                  <motion.div
                    animate={{ 
                      boxShadow: [
                        "0 0 20px hsl(var(--royal-blue) / 0.3)",
                        "0 0 40px hsl(var(--royal-blue) / 0.6)",
                        "0 0 20px hsl(var(--royal-blue) / 0.3)"
                      ]
                    }}
                    transition={{ duration: 2, repeat: Infinity }}
                    className="inline-block px-8 py-3 rounded-full bg-gradient-to-r from-royal-blue to-royal-blue-dark text-white font-bold text-lg"
                  >
                    🏆 Quantum Wins! Unbreakable Security 🏆
                  </motion.div>
                </motion.div>
              </CardContent>
            </Card>
